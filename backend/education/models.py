...
class Curriculum(models.Model):
    ...
    password = models.CharField(_('수강비밀번호'), max_length=128)
...
class Lecture(models.Model):
    ...
    division = models.ForeignKey(
        LectureDivision,
        on_delete=models.SET_DEFAULT,
        default=1  # have to set default CurriculumDivision
    )
...
class Lesson(models.Model):
    ...
    url = models.CharField(_('영상 주소'), max_length=258)
...
class CurriculumStudent(models.Model):
    ...
    reg_date = models.DateTimeField(_('등록일'))
...
class CurriculumProgress(models.Model):
    ...
    date = models.DateTimeField(_('학습 완료일'))
